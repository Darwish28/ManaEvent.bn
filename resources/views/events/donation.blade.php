...
<div class="max-w-md mx-auto overflow-hidden rounded-b-2xl">
    <img src="/images/donation.png" alt="Donation Event" class="w-full h-auto object-cover rounded-b-2xl">
</div>

<section class="p-5 text-gray-800">
    <h2 class="text-lg font-extrabold mb-2">EVENT DETAILS:</h2>
    <p class="text-sm mb-4 leading-relaxed">
        Join us for a charity event dedicated to supporting underprivileged communities across Brunei. 
        Together, we can make a difference through donations, volunteerism, and compassion.
    </p>

    <p><span class="text-red-500">📍</span> <strong>LOCATION:</strong> Yayasan Complex, Bandar Seri Begawan</p>
    <p><span class="text-gray-800">📅</span> <strong>DATE:</strong> 5th October, 10AM–5PM</p>
</section>
